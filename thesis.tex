\documentclass[master=wit,english,fleqn,openright]{misc/kulemt}
...
\input{parts/misc/preface}
\input{parts/misc/abstract}
\tableofcontents*
\input{parts/misc/lists.tex}
...
\mainmatter
\input{parts/chap-1/0-chap-1} 
\input{parts/chap-2/0-chap-2}
\input{parts/chap-3/0-chap-3}
\input{parts/chap-4/0-chap-4}
\input{parts/chap-5/0-chap-5}
